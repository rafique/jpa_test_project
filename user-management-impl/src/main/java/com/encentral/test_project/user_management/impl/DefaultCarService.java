...
public class DefaultCarService implements CarService 
{
    ...
    public JpaCar update(JpaCar carDO) throws ResourceNotFound 
	{
		...
		car.setUsername(carDO.getUsername());
		car.setPassword(carDO.getPassword());
		car.setOnlineStatus(carDO.getOnlineStatus());
		car.setDeleted(carDO.getDeleted());
		car.setDateCreated(carDO.getDateCreated());
		car.setDateModified(carDO.getDateModified());
